...
### Round 2 Scenarios — Advanced Sub-Models & Capacity Bounds (Round 6)
...
> [!TIP]
> **Round 2 Findings:**
> Random Forest (S29) unexpectedly became our best single model with a valid, un-leaked CV RMSE of **40.48**. This represents a true ~0.65 RMSE improvement over the pre-Round 2 XGBoost baseline (S6: 41.14), proving that structural ceilings, spatial clusters, and censored/zero-inflated logic provided genuine predictive lift.

### Round 2 Hyperparameter Tuning & Finalization (Round 7)

| #    | Strategy                  | Algorithm | Key Difference | Status |
| ---- | ------------------------- | --------- | -------------- | ------ |
| 32   | `strategyA_gravity_only`  | XGBoost   | Optuna tuned (50 trials, GPU) on un-leaked Round 2 features | ✅ Done (**40.11**) |
| 33   | `strategyA_gravity_only`  | LightGBM  | Optuna tuned (50 trials, GPU) on un-leaked Round 2 features | ✅ Done (**41.02**) |
